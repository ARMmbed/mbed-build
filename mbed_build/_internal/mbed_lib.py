...
from mbed_build._internal.find_files import find_files, MbedignoreFilter


def find_mbed_lib_files(mbed_program_directory: Path) -> Iterable[Path]:
    ...
    return find_files("mbed_lib.json", mbed_program_directory, [legacy_ignore])
