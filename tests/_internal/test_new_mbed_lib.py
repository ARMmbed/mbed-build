...
from mbed_build._internal.new_mbed_lib import find_mbed_lib_files


class TestFindMbedLibFiles(TestCase):
    @mock.patch("mbed_build._internal.new_mbed_lib.find_files", autospec=True)
    @mock.patch("mbed_build._internal.new_mbed_lib.BoardLabelFilter", autospec=True)
