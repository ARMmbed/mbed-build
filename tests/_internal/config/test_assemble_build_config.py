...
from mbed_build._internal.config.assemble_build_config import (
...
@mock.patch(
    "mbed_build._internal.config.assemble_build_config._assemble_config_from_sources_and_lib_files", autospec=True
)
